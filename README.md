...
实验一的图：VICM (ours)，在粉色区域写一下  ？

fig6 b 箭头降低%多少

the rms of     fig6c
fig6 a b d没在正文说，改善多少也没说

fig 7 看不出来哪个是VICM和SRBM,axxx/afull

fig7 ab shows that 47%

conclusion里面量化指标要写出来

introduction里也一样

为了适用xx控制，机器人腿部质量设计比较轻

人体各部位重量分布


fig5 vy不放了 a lamda = 1  b lamda = 1.7  30s ，梯度拉长

覆盖区域 是蓝色的

-----
摘要，总结中的量化贡献需要重新更新
<!-- 实验3 形式完全不变，改成 lamda = 1.8 下，问题不大了   -->

正文公式推导需要再检查 以及文字
AI声明以及共同作者邮箱

式3中不提Iw转换，在后面实验的时候提一下做了坐标转换，直接用I0表达就行了
式6及相关描述去掉，不单独解释这个
